            ...
            CREATE PROCEDURE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [8d460465-ab53-431f-a27a-8d928a8e1f6c].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [8d460465-ab53-431f-a27a-8d928a8e1f6c].data_input_row
                INNER JOIN [8d460465-ab53-431f-a27a-8d928a8e1f6c].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
