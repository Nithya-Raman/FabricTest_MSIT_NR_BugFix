              ...
              CREATE PROCEDURE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [8d460465-ab53-431f-a27a-8d928a8e1f6c].powertable_approval_request_rows SET status = 500 FROM [8d460465-ab53-431f-a27a-8d928a8e1f6c].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
