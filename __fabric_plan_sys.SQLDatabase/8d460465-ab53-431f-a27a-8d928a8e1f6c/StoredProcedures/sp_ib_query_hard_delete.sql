      ...
      CREATE   PROCEDURE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback] qw
