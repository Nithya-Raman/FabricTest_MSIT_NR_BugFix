CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_automation_jobs] ([id])
);
