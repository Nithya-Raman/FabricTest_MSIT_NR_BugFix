CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_source]([recordGuid] ASC);
