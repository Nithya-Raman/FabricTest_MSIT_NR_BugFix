CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[visual] ([id]) ON DELETE CASCADE
);
