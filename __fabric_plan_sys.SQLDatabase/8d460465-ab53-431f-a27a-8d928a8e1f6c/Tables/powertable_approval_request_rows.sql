CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_request] ([id])
);
