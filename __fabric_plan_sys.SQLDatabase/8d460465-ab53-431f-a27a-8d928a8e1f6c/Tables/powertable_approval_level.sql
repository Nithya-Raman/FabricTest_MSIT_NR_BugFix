CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_level]([recordGuid] ASC);
