CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_transformation_steps]([recordGuid] ASC);
