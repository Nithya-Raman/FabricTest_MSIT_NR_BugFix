CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[writeback_settings]([recordGuid] ASC);
