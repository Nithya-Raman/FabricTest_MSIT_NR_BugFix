CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_column_config]([recordGuid] ASC);
