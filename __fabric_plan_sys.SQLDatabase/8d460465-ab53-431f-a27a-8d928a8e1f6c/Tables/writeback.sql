CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[visual] ([id])
);
