CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_forms]([recordGuid] ASC);
