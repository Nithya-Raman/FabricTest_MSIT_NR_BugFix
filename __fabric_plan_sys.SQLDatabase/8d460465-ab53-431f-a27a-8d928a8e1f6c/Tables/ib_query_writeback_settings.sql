CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback_settings]([recordGuid] ASC);
