CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[visual] ([id])
);
