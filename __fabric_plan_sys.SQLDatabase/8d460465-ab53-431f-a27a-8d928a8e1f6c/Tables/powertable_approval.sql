CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval]([recordGuid] ASC);
