CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[ib_query_writeback_destination]([recordGuid] ASC);
