CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_row_access_filters]([recordGuid] ASC);
