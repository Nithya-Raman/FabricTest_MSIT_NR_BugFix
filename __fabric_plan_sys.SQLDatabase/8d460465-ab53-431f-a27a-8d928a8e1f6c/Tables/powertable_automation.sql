CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_automation]([recordGuid] ASC);
