CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_filter]([recordGuid] ASC);
