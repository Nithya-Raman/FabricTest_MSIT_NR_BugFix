CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_approval_request] ([id])
);
