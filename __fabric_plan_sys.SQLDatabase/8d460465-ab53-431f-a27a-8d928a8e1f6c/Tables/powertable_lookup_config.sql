CREATE TABLE [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [8d460465-ab53-431f-a27a-8d928a8e1f6c].[powertable_lookup_config]([recordGuid] ASC);
